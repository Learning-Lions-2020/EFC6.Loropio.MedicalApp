...
public class MedicalAppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Patient>().HasData(
            ...
            new Patient { Id = 3, Name = "Alice Makeke", DateOfBirth = new DateTime(1996, 2, 11), Address = "789 Pine St" },
        ...
        modelBuilder.Entity<Appointment>().HasData(
            new Appointment { Id = 1, PatientId = 1, DoctorId = 1, Date = DateTime.Now }, // John Doe with Dr. Thomas
            new Appointment { Id = 2, PatientId = 2, DoctorId = 2, Date = DateTime.Now.AddDays(1) }, // Jane Smith with Dr. Jerry
            new Appointment { Id = 3, PatientId = 3, DoctorId = 3, Date = DateTime.Now.AddDays(2) }, // Alice Makeke with Dr. Boniface
            new Appointment { Id = 4, PatientId = 4, DoctorId = 4, Date = DateTime.Now.AddDays(3) }  // Kuya Nacho with Dr. Olsen
        );
