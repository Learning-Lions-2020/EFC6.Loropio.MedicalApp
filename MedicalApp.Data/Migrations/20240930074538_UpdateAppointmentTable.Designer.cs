...
namespace MedicalApp.Data.Migrations
{
    ...
    [Migration("20240930074538_UpdateAppointmentTable")]
            ...
            modelBuilder.Entity("MedicalApp.Domain.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 9, 30, 10, 45, 38, 54, DateTimeKind.Local).AddTicks(1320),
                            DoctorId = 1,
                            PatientId = 1
                        },
                        new
                        {
                            Id = 2,
                            Date = new DateTime(2024, 10, 1, 10, 45, 38, 54, DateTimeKind.Local).AddTicks(1330),
                            DoctorId = 2,
                            PatientId = 2
                        });
                });
