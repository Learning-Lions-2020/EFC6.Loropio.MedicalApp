...
namespace MedicalApp.Data.Migrations
{
    ...
    [Migration("20240930052715_UpdateCurrentDatabase")]
    partial class UpdateCurrentDatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalApp.Domain.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 9, 30, 8, 27, 15, 371, DateTimeKind.Local).AddTicks(8787),
                            DoctorId = 1,
                            MyProperty = 1,
                            PatientId = 1
                        },
                        ...
                        {
                            Id = 2,
                            Date = new DateTime(2024, 10, 1, 8, 27, 15, 371, DateTimeKind.Local).AddTicks(8795),
                            DoctorId = 2,
                            MyProperty = 2,
                            PatientId = 2
                        });
